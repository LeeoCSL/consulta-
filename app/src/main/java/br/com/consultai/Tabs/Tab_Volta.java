...
public class Tab_Volta extends Fragment {
    ...
    public static final  String tipo = "1"; //volta
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(rb_onibus.isChecked() && !estudante){
                    valor = tarifa_comum;
                }
                else if(rb_integracao.isChecked() && !estudante){
                    valor = tarifa_integracao;
                }
                if(rb_onibus.isChecked() && estudante){
                    valor = tarifa_estudante;
                }
                else if(rb_integracao.isChecked() && estudante){
                    valor = integracao_estudante;
                }
